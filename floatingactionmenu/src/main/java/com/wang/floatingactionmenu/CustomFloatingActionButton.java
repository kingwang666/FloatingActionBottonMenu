...
public class CustomFloatingActionButton extends AppCompatImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.CustomFloatingActionButton, 0, 0);
        mColorNormal = attr.getColor(R.styleable.CustomFloatingActionButton_fab_colorNormal, getColor(android.R.color.holo_blue_dark));
        mColorPressed = attr.getColor(R.styleable.CustomFloatingActionButton_fab_colorPressed, getColor(android.R.color.holo_blue_light));
        mColorDisabled = attr.getColor(R.styleable.CustomFloatingActionButton_fab_colorDisabled, getColor(android.R.color.darker_gray));
        mSize = attr.getInt(R.styleable.CustomFloatingActionButton_fab_size, SIZE_NORMAL);

        mIcon = attr.getResourceId(R.styleable.CustomFloatingActionButton_fab_icon, 0);
        mTitle = attr.getString(R.styleable.CustomFloatingActionButton_fab_title);
        mStrokeVisible = attr.getBoolean(R.styleable.CustomFloatingActionButton_fab_stroke_visible, true);
