...
public class SubActionButton extends FrameLayout {
    ...
    public SubActionButton(Context context, FrameLayout.LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View contentView, FrameLayout.LayoutParams contentParams) {
        ...
        if(backgroundDrawable == null) {
            if(theme == THEME_LIGHT) {
                backgroundDrawable = ContextCompat.getDrawable(getContext(), R.drawable.button_sub_action_selector);
            }
            else if(theme == THEME_DARK) {
                backgroundDrawable = ContextCompat.getDrawable(getContext(), R.drawable.button_sub_action_dark_selector);
            }
            else if(theme == THEME_LIGHTER) {
                backgroundDrawable = ContextCompat.getDrawable(getContext(), R.drawable.button_action_selector);
            }
            else if(theme == THEME_DARKER) {
                backgroundDrawable = ContextCompat.getDrawable(getContext(), R.drawable.button_action_dark_selector);
            }
            else {
    ...
    /**
     * A builder for {@link SubActionButton} in conventional Java BaseBuilder format
     */
